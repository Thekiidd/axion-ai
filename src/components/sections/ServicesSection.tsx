...
export function ServicesSection() {
  return (
    <section id="servicios" className="px-12 py-[120px] bg-[#0D0D18]">
      ...
      <div
        className="grid grid-cols-1 md:grid-cols-3 gap-[2px] bg-white/[0.07] rounded-3xl overflow-hidden reveal"
      >
        {SERVICES.map((svc) => (
          <div
            key={svc.num}
          ...
          >
            ...
            <span className="inline-flex items-center gap-2 bg-[rgba(200,255,0,0.08)] border border-[rgba(200,255,0,0.2)] text-[#C8FF00] px-4 py-[7px] rounded-full text-[13px] font-semibold">
              {svc.price}
            </span>
